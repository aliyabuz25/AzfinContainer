        ...
        <aside className="space-y-6 sticky top-8">
            ...
            <div className="bg-slate-50/50 rounded-[32px] border border-slate-100 p-2 max-h-[75vh] overflow-y-auto custom-scrollbar shadow-sm">
                ...
                <button
                    ...
                    className={`w-full flex items-center justify-between px-5 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all mb-1 ${adminMode === 'forms'
                        ? 'bg-primary text-white shadow-lg shadow-primary/20'
                        : 'text-slate-500 hover:bg-white hover:text-primary group'
                        }`}
                >
                    <div className="flex items-center gap-4">
                        <FileJson className={`h-4 w-4 ${adminMode === 'forms' ? 'text-accent' : 'text-slate-300 group-hover:text-primary'}`} />
                        FORMLAR
                    </div>
                ...
                <button
                    ...
                    className={`w-full flex items-center justify-between px-5 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all mb-1 ${adminMode === 'social'
                        ? 'bg-primary text-white shadow-lg shadow-primary/20'
                        : 'text-slate-500 hover:bg-white hover:text-primary group'
                        }`}
                >
                    <div className="flex items-center gap-4">
                        <FileJson className={`h-4 w-4 ${adminMode === 'social' ? 'text-accent' : 'text-slate-300 group-hover:text-primary'}`} />
                        SOSİAL LİNKLƏR
                    </div>
                ...
                >
                    <div className="flex items-center gap-4">
                        <FileJson className={`h-4 w-4 ${adminMode === 'clients' ? 'text-accent' : 'text-slate-300 group-hover:text-primary'}`} />
                        MÜŞTƏRİLƏR
                    </div>
